    ...
    return (
        <div style={{ backgroundColor: "white", marginTop: "60px", marginBottom:"80px", display: "flex", justifyContent: "space-between", flexWrap: "wrap" }}>
            <ProjectCard
                ...
                url="./src/components/videos/wanderlust.png"
            ...
            <ProjectCard
                ...
                url="./src/components/videos/InvestmentTracker.png"
            ...
            <ProjectCard
                Title="Spotify Clone"
                url="./src/components/videos/Spotify.png"
            ...
            <ProjectCard
                Title="CatFacts"
                url="./src/components/videos/CatFact.png"
